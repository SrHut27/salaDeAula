    ...
    <section id="conheca" ref={sectionRef} className={styles.missionSection}>
      ...
      <div className={styles.contentWrapper}>
        ...
        <p className={styles.description}>
          A Escola Maria Peregrina está há 18 anos em São José do Rio Preto-SP e tem 20 anos de fundação. Hoje, há necessidade de expandir para continuar o desenvolvimento integral do aluno e transformação na família, que é o primeiro aluno. Muitos alunos típicos e atípicos tiveram um alto desenvolvimento devido à única sala de aula: o pátio pedagógico. Por isso, temos a necessidade de construir uma nova sala de aula mais ampla e mais avançada, a fim de melhor atender nossos alunos.  
        </p>
      </div>
    </section>
  );
